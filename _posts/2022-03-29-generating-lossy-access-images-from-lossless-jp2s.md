...
|Target compression ratio layers|2560:1 [1] ; 1280:1 [2] ;  640:1 [3] ; 320:1 [4] ; 160:1 [5] ; 80:1 [6] ; 40:1 [7] ; 20:1 [8] ; 10:1 [9] ; 5:1 [10] ; 2.5:1 [11]|2560:1 [1] ; 1280:1 [2] ;  640:1 [3] ; 320:1 [4] ; 160:1 [5] ; 80:1 [6] ; 40:1 [7] ; 20:1 [8]|
...
For each of the three codecs, I created a simple Bash script that takes an input and an output directory as its arguments. For each JP2 image in the input directory, it then goes through the following steps:

1. Convert the JP2 to uncompressed TIFF.
2. Compress the TIFF to lossy JP2, using (to the maximum extent posssible) the KB's access JP2 requirements[^5].
...
I ran each of the scripts on a directory with 26 preservation master JP2s (144 MB) from the KB's collection of digitised books. Before running any of the scripts, I used the following command to empty the cache memory:
